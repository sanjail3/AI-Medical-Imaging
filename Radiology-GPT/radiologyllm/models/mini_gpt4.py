...
from radiologyllm.models.blip2 import Blip2Base, disabled_train
from radiologyllm.models.modeling_llama import LlamaForCausalLM
from transformers import LlamaTokenizer
from transformers import StoppingCriteria, StoppingCriteriaList #for imprgpt eval
import csv #for imprgpt rogue eval
from radiologyllm.conversation.conversation import Conversation
...
class MiniGPT4(Blip2Base):
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "pretrain_vicuna": "configs/models/radiologyllm.yaml",
    }
